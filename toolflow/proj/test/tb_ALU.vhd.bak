...
architecture behavior of tb_ALU is
  ...
  component ALU
    ...
    port (
      ...
      i_ALU_Ctl      : in  std_logic_vector(4 downto 0);
  ...
  signal i_ALU_Ctl : std_logic_vector(4 downto 0)  := (others => '0');
